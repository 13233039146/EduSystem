...
SECRET_KEY = 'e_!i4q8c7i$8h0-28%hd4q1v@+86ccp^!2v!loa81n5pae#f7r'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['api.baizhiedu.net']
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # 新增这一行
...
ALIPAY_CONFIG = {
    ...
    "notify_url": "http://api.baizhiedu.net:8000/payments/result",  # 异步结果通知
}